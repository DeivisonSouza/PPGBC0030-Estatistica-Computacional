...
subtitle: "Tidyverse: manipulação de dados"
...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Tidyverse: manipulação de dados`r anicon::faa("pagelines", animate="horizontal", colour="green")`
<br>
...
## Objetivos
<br>
Esta aula (.blue[Tidyverse: manipulação de dados]) constitui a segunda parte do módulo 2 destinado ao aprendizado de alguns pacotes da coleção Tidyverse. Ao final desta aula espera-se que os participantes possam alcançar conhecimentos para...
<br><br>
...
.font200[**.yellow[Parte 3] <br> .white[Manipulação de dados <br> com dplyr]**]
