...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Manipulação de dados em R`r anicon::faa("pagelines", animate="horizontal", colour="green")`
<br>
...
## Objetivos
<br><br>
Ao final desta terceira parte (.blue[Manipulação de Dados em R]) espera-se que os participantes possam alcançar conhecimentos para...
<br><br>
