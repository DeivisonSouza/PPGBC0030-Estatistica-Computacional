...
subtitle: "Introdução ao Tidyverse: .orange[ggplot2]"
...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Introdução ao Tidyverse: .orange[ggplot2]`r anicon::faa("pagelines", animate="horizontal", colour="green")`
<br>
...
## Objetivos
<br>
Esta aula (.blue[Introdução ao Tidyverse: ggplot2]) constitui a terceira parte do módulo 2 destinado ao aprendizado de alguns pacotes da coleção Tidyverse. Ao final desta aula espera-se que os participantes possam alcançar conhecimentos para...
<br><br>
...
[2 - O Pacote .orange[ggplot2]](#ggplot2)
...
.right[.font150[**.green[Parte 3] - Visualização de dados: <br> Pacote .orange[ggplot2]**]]
...
- O **Tidyverse** incorpora o pacote .orange[**ggplot2**], um framework sensacional para construção de gráficos elegantes.
]
<br><br>

.center[**O pacote .orange[ggplot2] será o nosso objeto de estudo!**]

---
name: ggplot2
## O pacote .orange[ggplot2] (tidyverse)
<br>

.font90[
- O .orange[ggplot2] é um pacote para .blue[visualização de dados] disponível no R.
...
- A essência do .orange[ggplot2] é a construção de gráficos ".blue[camada por camada]".
- O .orange[ggplot2] possui .brown[vantagens] frente ao R-base:
...
---
name: gramatica
## .orange[ggplot2] e a gramática dos gráficos
<br>

```{r echo=FALSE, out.width='55%', fig.align='center', fig.cap='', dpi=600}
knitr::include_graphics("fig/part4/ggplot.png")
```
.center[.font70[**Fonte**: https://r.qcbs.ca/workshop03/pres-en/workshop03-pres-en.html#113]]

---
name: data
## Pacote .orange[ggplot2] (tidyverse)
...
**A base completa pode ser acessada em**: [IF100%](https://deivisonsouza.github.io/FL03034-EF/Slides/ %>% /UPA07DVS.csv)
...
.right[.font150[**.green[Parte 3] - Visualização de dados: <br> Combine Gráficos com Pacote .orange[Patchwork]**]]
...
---
name: patchwork
## Pacote .orange[Patchwork] - Combine gráficos
...
class: with-logo logo-ufpa
<div class="my-header"></div>
<div class="my-footer"><span>Prof. Dr. Deivison Venicio Souza (E-mail: deivisonvs@ufpa.br)&emsp;&emsp;&emsp;&emsp;&emsp; <div3>Introdução ao R para Análise de Dados</div3>/ <div2>Parte 3 - Visualização de dados com ggplot2 e extensões</div2> </div>
