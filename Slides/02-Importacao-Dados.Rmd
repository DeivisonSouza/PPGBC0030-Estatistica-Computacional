...
subtitle: "Importação de dados com R"
...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Tidyverse: importação de dados`r anicon::faa("pagelines", animate="horizontal", colour="green")`
<br>
...
## Objetivos
<br>
Esta aula (.blue[Tidyverse: importação de dados]) constitui a primeira parte do módulo 2 destinado ao aprendizado de alguns pacotes da coleção Tidyverse. Ao final desta aula espera-se que os participantes possam alcançar conhecimentos para...
<br><br>
