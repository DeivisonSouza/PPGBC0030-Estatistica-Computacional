...
- 5) **Livros**: R Markdown + bookdown para criar livros;
- 6) **Websites**: O R Markdown facilita a criação de páginas web diretamente de arquivos .Rmd; (Páginas pessoais, blogs, projetos,...)
]
