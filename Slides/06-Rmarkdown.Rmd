...
### **O que é R Markdown?**
.font90[
- É um pacote/biblioteca disponível na linguagem R; (`install.packages("rmarkdown")`)
- Na essência, o .magenta[R Markdown] é a junção da linguagem de marcação .brown[Markdown] com o poder de códigos em R ([Ciência de Dados em R](https://livro.curso-r.com/9-2-r-markdown.html)).
]
]
...
### **Markdown?**
.font90[
- É uma **linguagem de marcação** simples para formatação de textos.
- É usada como ferramenta de **conversão de texto para HTML**, linguagem usada para criar páginas da web.
- A sintaxe baseia-se, na maioria dos casos, em caracteres não-alfabéticos (`#, ![](), *`), usados para a configuração de títulos, listas, negrito, inserção de imagens e links, e entre outros.
]
]
...
- **Adicionando: Títulos, subtítulos, ...**
