...
- Cada grupo (até 4 pessoas) deverá criar um Projeto (.Rproj) e desenvolver uma AED. Inicialmente, explore os pacotes estudados (**readr**, **dplyr**, **ggplot2**, etc.). Fique a vontade para explorar outras bibliotecas especializadas em AED, como 
