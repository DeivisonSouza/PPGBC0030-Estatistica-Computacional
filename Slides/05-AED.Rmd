...
- Vamos realizar uma análise exploratória do conjunto ".brown[**Iris Flower**]". Inicialmente, prefira usar os pacote estudados (**readr**, **dplyr**, **ggplot2**).
...
2) Realize uma estatística descritiva para as variáveis quantitativas. (geral e por espécie)

3) Crie as seguintes visualizações:
