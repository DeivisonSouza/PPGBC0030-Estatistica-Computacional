...
subtitle: "Visualização de dados com ggplot2 e extensões"
...
## .font90[Parte 3 - Visualização de dados <br> com ggplot2 e extensões] `r anicon::faa("pagelines", animate="horizontal", colour="green")`
