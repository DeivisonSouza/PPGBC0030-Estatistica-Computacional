...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Introdução ao R-base `r anicon::faa("pagelines", animate="horizontal", colour="green")`
<br>
...
.pull-left-4[
**Parte 3 - Mecanismos de Indexação no R**
...
.right[.font150[**.green[Parte 3] - Mecanismos de Indexação no R**]]
